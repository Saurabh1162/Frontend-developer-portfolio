    ...
    return (
        <Nav>
            <NavContainer className={isScroll ? "scrolled" : ""}>
                ...
                <ButtonContainer>
                    <Button href="https://github.com/Saurabh1162" target="blank">Github</Button>
                    <Button href="https://www.linkedin.com/in/saurabh-more-92011522b/" target="blank">LinkedIn</Button>
                    <Button href="https://drive.google.com/file/d/1nfp38J_3KgfzlrE5feAjPkIdB9RhjX72/view?usp=sharing"target="blank">Resume</Button>
                </ButtonContainer>
